...
namespace Library
{
    ...
    public:	
		...
		const mat4x4& OffsetTransform() const;
		mat4x4 OffsetTransformMatrix() const;

		Bone(const std::string& name, UINT index, const mat4x4& offsetTransform);
    ...
    private:
		...
		mat4x4 mOffsetTransform;	// Transforms from mesh space to bone space
    };
}

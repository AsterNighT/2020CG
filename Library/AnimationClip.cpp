...
namespace Library
{
	...
	UINT AnimationClip::GetTransform(float time, Bone& bone, mat4x4& transform) const
	{
	...
	void AnimationClip::GetTransforms(float time, std::vector<mat4x4>& boneTransforms) const
	{
		for (BoneAnimation* boneAnimation : mBoneAnimations)
		{
	...
	void AnimationClip::GetTransformAtKeyframe(UINT keyframe, Bone& bone, mat4x4& transform) const
	{
		auto foundBoneAnimation = mBoneAnimationsByBone.find(&bone);
		if (foundBoneAnimation != mBoneAnimationsByBone.end())
		{
	...
	void AnimationClip::GetTransformsAtKeyframe(UINT keyframe, std::vector<mat4x4>& boneTransforms) const
	{
		for (BoneAnimation* boneAnimation : mBoneAnimations)
		{
	...
	void AnimationClip::GetInteropolatedTransform(float time, Bone& bone, mat4x4& transform) const
	{
		auto foundBoneAnimation = mBoneAnimationsByBone.find(&bone);
		if (foundBoneAnimation != mBoneAnimationsByBone.end())
		{
	...
	void AnimationClip::GetInteropolatedTransforms(float time, std::vector<mat4x4>& boneTransforms) const
	{
		for (BoneAnimation* boneAnimation : mBoneAnimations)
		{
